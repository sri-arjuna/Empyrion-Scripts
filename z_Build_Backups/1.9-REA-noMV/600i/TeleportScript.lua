{{#dialog 'tTPAtrium;tTPBar;tTPHangRear;tTPProduction;tTPHangFront'
{{#dialog 'tTPAtrium,tTPBar,tTPHangRear,tTPProduction,tTPHangFront'
{{#dialog 'tTPHangRear'
'Teleport'
'
...
<link="T2"><color=yellow>◉ Bridge Combat
</color></link>
<link="T3"><color=yellow>◉ Atrium / Teleporter
</color></link>
<link="T4"><color=orange>◉ Open Bar
</color></link>
<link="T5"><color=red>◉ Hangar Front
</color></link>
<link="T6"><color=blue>◉ Production (Hanger center)
</color></link>
<link="T7"><color=red>◉ Hangar Rear
</color></link>
