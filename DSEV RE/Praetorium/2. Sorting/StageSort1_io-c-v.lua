...
{{~#move . @root.E.S 'StageSorting1'}}
 {{datetime 'HH:mm:ss'}} <pos=75>| <color=orange>Stage</color></pos><pos=125>| {{Count}}</pos><pos=180>| {{i18n Id}} </pos><pos=460>| {{Source}} <color=green>❱</color> {{Destination}}</pos>
{{/move}}
-- -------------------------------------------------------
** TODO **
-- c-Solar Cell-5998
